...
public class StudentsTester
{
    public static void main(String[] args)
    {
        ...
        FoodItem f0 = new FoodItem("Milk", 1111, 12, t2, t3, 7, 10, 5);
        FoodItem f2 = new FoodItem("Honey", 2222, 2, t1, t3, 6, 10, 20);
        FoodItem f3 = new FoodItem("PopCorn", 3333, 2, t1, t3, 6, 10, 12);
        FoodItem f4 = new FoodItem("Mayo", 4444, 2, t1, t3, 6, 10, 12);

        Stock st = new Stock();
        System.out.println(st.getTempOfStock());
        // for(int i=0; i < 100; i++)
        // {
            // FoodItem f = new FoodItem("item"+i, 4000+i, 12, t1, t2, 7, 10, 5);
            // st.addItem(f);
        // }
        st.addItem(f1);
        st.addItem(f0);
